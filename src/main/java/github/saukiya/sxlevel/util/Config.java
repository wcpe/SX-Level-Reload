...
public class Config {
    ...
    public static final String LEVEL_UP_STRING_ACTION = "level-up-string-action";
    private static final File FILE = new File(SXLevel.getPlugin().getDataFolder(), "Config.yml");
    private static boolean sql = false;
    private static final Boolean dataUseUuidSave = false;
    ...
    public static Boolean getDisabledDefaultExpChange() {
        return disabledDefaultExpChange;
    }

    public static Boolean getSxLevelSetDefaultExp() {
        return sxLevelSetDefaultExp;
    }
    ...
    public static Boolean getDataUseUuidSave() {
        return dataUseUuidSave;
    }
    ...
    private static void createDefaultConfig() {
        ...
        config.set(SQL_DATABASE_NAME, "root");
        config.set(SQL_TABLE_NAME, "sxlevel");
        ...
        config.set(LEVEL_UP_STRING_ACTION + ".5", Arrays.asList("成功升级至xxx", "[TITLE]10;70;20; ;成功升级至xxx"));
    }
